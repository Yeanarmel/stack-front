    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-4xl w-full bg-white shadow-lg rounded-xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="email" name="email" className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required/>
            </div>

            <div>
              <label className="block text-sm font-medium mb-1">Password</label>
              <input type="password" name="password" className="w-full border rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required />
            </div>
        ...
        <div className="hidden md:block md:w-1/2 bg-gradient-to-b from-blue-100 to-purple-200">
          <img src="/images/auth-side.png" alt="Developer collaboration" className="h-full w-full object-cover"/>
        </div>
      </div>
    </div>
  );
