  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-2">
        ...
        <NavLink to="/questions" onClick={onClose} className={({ isActive }) =>
          `${linkBase} ${isActive ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-blue-50"}`
        }>
          <HelpCircle size={20} /> Questions
        </NavLink>

        <NavLink to="/tags" onClick={onClose} className={({ isActive }) =>
          `${linkBase} ${isActive ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-blue-50"}`
        }>
          <Tag size={20} /> Tags
        </NavLink>

        <NavLink to="/leaderboard" onClick={onClose} className={({ isActive }) =>
          `${linkBase} ${isActive ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-blue-50"}`
        }>
